...
public class CreateBooksCase {
	private final static Logger logger = LoggerFactory.getLogger(CreateBooksCase.class);
	...
	public void testCreateBooks() throws InterruptedException {
	...
	public void testCode() throws IOException, RowsExceededException,
			WriteException {
		...
		WritableWorkbook book = Workbook.createWorkbook(new File(
				"classes/WEB-INF/classes/Code.xls"));
		// 生成名为“sheet1”的工作表，参数0表示这是第一页
		WritableSheet sheet = book.createSheet("code", 0);
