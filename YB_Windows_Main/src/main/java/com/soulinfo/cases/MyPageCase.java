...
public class MyPageCase {
	private final static Logger logger = LoggerFactory.getLogger(MyPageCase.class);
	 ...
	 */
	public void testCreateMyPage(YBEntity yb, String classname)
			throws InterruptedException {
		...
		logger.info(yb.getUsername() + "制作 个人书页完成");
...
//	public void submitMyPage(YBEntity yb, String classname)
//			throws InterruptedException {
...
//		element.findByCssClick("button.aui_state_highlight");
//		
//		logger.info(yb.getUsername() + "重新提交 个人书页完成");
//
//	}
